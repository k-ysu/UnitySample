...
struct  X509EnhancedKeyUsageExtension_t559  : public X509Extension_t539
{
	...
	OidCollection_t556 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t559_StaticFields{
	...
	Dictionary_2_t77 * ___U3CU3Ef__switchU24mapE_6;
};
