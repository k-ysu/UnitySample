...
struct  X509Store_t553  : public Object_t
{
	...
	X509Certificate2Collection_t544 * ___list_2;
	...
	X509Store_t567 * ___store_4;
};
struct X509Store_t553_StaticFields{
	...
	Dictionary_2_t77 * ___U3CU3Ef__switchU24mapF_5;
};
